...
import com.example.project_kelas_c.MainActivity;
...
public class Edit_Teman2 extends AppCompatActivity {
    TextView idText;
    ...
    private static final String TAG = Edit_Teman2.class.getSimpleName();
        ...
        StringRequest stringReq = new StringRequest(Request.Method.POST, url_update, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (sukses == 1) {
                        Toast.makeText(Edit_Teman2.this, "SUkses mengedit data", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(Edit_Teman2.this, "gagal", Toast.LENGTH_SHORT).show();
                    }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(Edit_Teman2.this, "Gagal Edit Data",Toast.LENGTH_SHORT).show();
            }
        })
        {
            @Override
